    ...
    <div className="bg-white rounded-3xl border border-gray-150 p-6 md:p-8 max-w-md w-full mx-auto shadow-xl transition-all font-sans relative overflow-hidden" id="login-auth-card">
      ...
      <div className="grid grid-cols-2 gap-1.5 p-1 bg-slate-100 rounded-xl mb-6">
        <button
          ...
          className={`py-2 px-3 text-xs font-extrabold rounded-lg transition-all cursor-pointer flex items-center justify-center gap-1.5 ${roleMode === "client" ? "bg-white text-emerald-950 shadow-xs" : "text-gray-500 hover:text-gray-900"
            }`}
        >
        ...
        <button
          ...
          className={`py-2 px-3 text-xs font-extrabold rounded-lg transition-all cursor-pointer flex items-center justify-center gap-1.5 ${roleMode === "admin" ? "bg-white text-emerald-950 shadow-xs" : "text-gray-500 hover:text-gray-900"
            }`}
        >
      ...
      {roleMode === "client" && (
        <div className="flex justify-center gap-6 border-b border-gray-100 pb-3.5 mb-5 text-sm font-semibold">
          <button
            ...
            className={`pb-1 px-1 transition-all relative cursor-pointer ${mode === "login" ? "text-emerald-800" : "text-gray-450 hover:text-gray-800"
              }`}
          >
          ...
          <button
            ...
            className={`pb-1 px-1 transition-all relative cursor-pointer ${mode === "signup" ? "text-emerald-800" : "text-gray-450 hover:text-gray-800"
              }`}
          >
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder={isAr ? "مثال: eslamrezk80@gmail.com" : "e.g., eslamrezk80@gmail.com"}
